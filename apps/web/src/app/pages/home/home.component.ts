...
export class HomeComponent implements OnInit {
  ...
  submitMailChimp() {
    ...
    this.jsonp
      .get(
        `http://ng-atl.us15.list-manage.com/subscribe/post-json?u=0b058da04fc0ba7ae956cb672&amp;id=b623efabaf&subscribe=Subscribe&EMAIL=${
          this.signup.EMAIL
        }&FNAME=${this.signup.FNAME}&LNAME=${this.signup.LNAME}&b_0b058da04fc0ba7ae956cb672_b623efabaf=${
          this.signup.b_0b058da04fc0ba7ae956cb672_b623efabaf
        }&c=JSONP_CALLBACK`
      )
