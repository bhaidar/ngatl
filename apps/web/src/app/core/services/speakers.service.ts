...
export class SpeakersService {
  speakers: Array<any> = [
    ...
    },
    {
      ...
      bio:
        'Started his engineering career as a React dev for an educational startup in SF(@LRNG). Often contribute to many different Swift libraries and even launched an app on the app store.',
      beyondBio:
        "You'll often find him playing DoTA2 or simply outside staring at nature. Sometimes will open up his text editor and hack on some open source games from time to time."
    },
    {
      name: 'Erica Stanley',
    ...
    },
    {
      ...
      bio:
        'Aysegul is a JavaScript developer focusing on Angular, WebVR and Data Visualization. She is a Developer Expert at Google for Web Technologies/Angular and an active conference speaker. She worked as Senior Software Engineer at Autodesk Play, a 3D and VR authoring tool that is currently in beta. She enjoys teaching at a variety of non-profit organizations aiming to increase diversity in the software industry.'
    },
    {
      name: 'Brad Green',
    ...
    },
    {
      ...
      bio:
        "Carmen is a front-end engineer who likes writing code and solving challenging puzzles. She's currently working towards undertaking the path of Artificial Neural Networks and Machine Learning ... all one step at a time.\n" +
    ...
    },
    {
      ...
      beyondBio:
        'I had no idea I would end up working as a programmer. In fact, I used to think it was the last thing I would ever do. After taking a first year CS course focusing on Java and not understanding any of it, I decided I would work solely in my main field of study, Geomatics.\n' +
        '\n' +
    ...
    },
    {
      ...
      bio:
        'Shai is founder of HiRez.io - the funniest Angular video courses in the universe. \n' +
    ...
    },
    {
      ...
      beyondBio:
        "Kapunahele has done a lotta, lotta stuff because life is neat that way. One day, she discovered that she really liked JavaScript and Angular. It's never too late to do what you enjoy. The details will take care of themselves."
    },
    {
      name: 'Nathan Walker',
