...
export class WorkshopsService {
  workshops = [
    ...
    },
    {
      ...
      day: 'Jan 31',
      description:
        'The creator of Angular Universal, PatrickJS, guides us as we create a project using Universal. Topics will include best practices, pitfalls, performance considerations to name a few. Along with invaluable instruction, students will have major insights into how Universal works.',
      instructors: [
        {
          name: 'PatrickJS'
        }
    ...
    },
    {
      ...
      day: 'Jan 31',
      description:
        'GraphQL is on its way in and has proven itself a worthy solution to a component based app future. Scott Moss will guide students through getting started with GraphQL and Angular. Topics include libraries to use, typescript + graphql, testing, and much more.',
      instructors: [
        {
          name: 'Scott Moss'
        }
    ...
    },
    {
      ...
      day: 'Jan 31',
      description:
        'Workshop: Getting started with Angular is now easier than ever ... said no one ever. Yet with the right toolset we too can create magic. When I code with Angular I can deploy to Azure within minutes.\n' +
        ' \n' +
