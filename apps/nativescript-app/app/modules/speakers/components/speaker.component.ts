...
import { LinearGradient, AppService } from '@ngatl/nativescript';
import { TouchGestureEventData, PanGestureEventData, TouchAction } from 'tns-core-modules/ui/gestures';
...
export class SpeakerComponent extends BaseComponent implements AfterViewInit, OnInit {
  ...
  ngOnInit() {
    this.store.pipe(
      select( s => s.conference.speakers ),
