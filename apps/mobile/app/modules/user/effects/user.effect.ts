...
// // module
// import { LoggerService, SystemUser } from '@ngatl/api';
...
//   @Effect()
//   login$ = this._actions$.ofType(UserActions.ActionTypes.LOGIN).switchMap((action: UserActions.LoginAction) =>
//     this._userService
...
//   @Effect()
//   create$ = this._actions$.ofType(UserActions.ActionTypes.CREATE).switchMap((action: UserActions.CreateAction) =>
//     this._userService
