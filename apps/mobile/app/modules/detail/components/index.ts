...
export const DETAIL_COMPONENTS: any[] = [EventDetailComponent, SearchDetailComponent, SpeakerDetailComponent, SponsorDetailComponent];

export * from './event/event-detail.component';
export * from './search/search-detail.component';
export * from './speaker/speaker-detail.component';
export * from './sponsor/sponsor-detail.component';
