...
export class SpeakerService extends Cache {
  ...
  private _speakerList = [
    {
      name: 'Simona Cotin',
      image: '~/assets/images/Simona.jpg',
      company: 'Microsoft',
      social: {
    ...
    {
      name: 'Michael Moss',
      image: '~/assets/images/michaelmoss.jpg',
      company: 'OneSpeed',
      social: {
        twitter: 'realmike33'
      },
    ...
    {
      name: 'Erica Stanley',
      image: '~/assets/images/erica_stanley.jpg',
      company: 'SalesLoft',
      social: {
    ...
    {
      name: 'Aysegul Yonet',
      image: '~/assets/images/Aysegul.jpg',
      company: 'Nrwl',
      social: {
    ...
    {
      name: 'Chaela Womack',
      image: '~/assets/images/Chaela.jpg',
    ...
    {
      name: 'Kim Crayton',
      image: '~/assets/images/KimCrayton.jpg',
    ...
    },
    {
      ...
      image: '~/assets/images/Randall.jpg',
      company: 'Netflix',
      social: {
        twitter: 'rkoutnik'
      },
    ...
    },
    {
      ...
      image: '~/assets/images/Kapunahele.jpg',
      company: '',
      social: {
        twitter: 'kapunahele'
      },
    ...
    },
    {
      ...
      image: '~/assets/images/Dmitri.jpg',
    ...
    {
      name: 'Deanna Rowe',
      image: '~/assets/images/Deanna.jpg',
      company: 'Google',
      social: {
        twitter: 'djrowe9'
      }
    ...
    },
    {
      ...
      image: '~/assets/images/Brandon.jpg',
      company: '',
      social: {
    ...
    {
      name: 'Shmuela Jacobs',
      image: '~/assets/images/Shmuela.jpg',
      company: '',
      social: {
        twitter: 'ShmuelaJ'
      }
    ...
    {
      name: 'Jennifer Bland',
      image: '~/assets/images/JenniferBland.jpg',
    ...
    {
      name: 'Rachita Joshi',
      image: '~/assets/images/Rachita.jpg',
      company: '',
      social: {
        twitter: 'way2rach'
      }
    ...
    {
      name: 'John McSwain',
      image: '~/assets/images/JohnMcSwain.jpg',
    ...
    },
    {
      ...
      image: '~/assets/images/Wylesha.jpg',
  ...
  public count() {
    ...
    return Observable.of(this._speakerList.length);
  }
  ...
  public loadDetail(id) {
    ...
    return Observable.of(this.speakerList.find(s => {
      return s.social.twitter === id;
    }));
  }
}
