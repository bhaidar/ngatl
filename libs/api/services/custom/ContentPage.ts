...
export class ContentPageApi extends BaseLoopBackApi {
  ...
  public getStorageFile(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPages/:id/storageFile';
  ...
  public getSystemDomain(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPages/:id/systemDomain';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public getSystemUser(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPages/:id/systemUser';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public patchOrCreate(data: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPages';
    let _routeParams: any = {};
    let _postBody: any = {
      data: data
    };
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'PATCH';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPages/:id';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {
