...
export class StorageFileApi extends BaseLoopBackApi {
  ...
  public findByIdContentEvents(id: any, fk: any, customHeaders?: Function): Observable<any> {
    ...
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentEvents/:fk';
  ...
  public findByIdContentPages(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentPages/:fk';
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public findByIdContentProducts(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentProducts/:fk';
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public findByIdContentPosts(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentPosts/:fk';
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public getSystemDomain(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/systemDomain';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries contentEvents of StorageFile.
   *
   * @param {any} id StorageFile id
   *
   * @param {object} filter
  ...
  public getContentEvents(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentEvents';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts contentEvents of StorageFile.
   *
   * @param {any} id StorageFile id
   *
  ...
  public countContentEvents(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentEvents/count';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries contentPages of StorageFile.
   *
   * @param {any} id StorageFile id
   *
   * @param {object} filter
  ...
  public getContentPages(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentPages';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts contentPages of StorageFile.
   *
   * @param {any} id StorageFile id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countContentPages(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentPages/count';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries contentProducts of StorageFile.
   *
   * @param {any} id StorageFile id
   *
   * @param {object} filter
  ...
  public getContentProducts(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentProducts';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts contentProducts of StorageFile.
   *
   * @param {any} id StorageFile id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countContentProducts(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentProducts/count';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries contentPosts of StorageFile.
   *
   * @param {any} id StorageFile id
   *
   * @param {object} filter
  ...
  public getContentPosts(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentPosts';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts contentPosts of StorageFile.
   *
   * @param {any} id StorageFile id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countContentPosts(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id/contentPosts/count';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public patchOrCreate(data: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles';
    let _routeParams: any = {};
    let _postBody: any = {
      data: data
    };
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'PATCH';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/StorageFiles/:id';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {
