...
export class ConferenceEventApi extends BaseLoopBackApi {
  ...
  public getFile(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ConferenceEvents/:id/file';
  ...
  public patchOrCreate(data: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ConferenceEvents';
    let _routeParams: any = {};
    let _postBody: any = {
      data: data
    };
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'PATCH';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ConferenceEvents/:id';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {
