...
export class ContentPostApi extends BaseLoopBackApi {
  ...
  public getStorageFile(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPosts/:id/storageFile';
  ...
  public getSystemDomain(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPosts/:id/systemDomain';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public getSystemUser(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPosts/:id/systemUser';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public patchOrCreate(data: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPosts';
    let _routeParams: any = {};
    let _postBody: any = {
      data: data
    };
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'PATCH';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPosts/:id';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {
  ...
  public _template_basic_remote(options: any = {}, params: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPosts/_template_basic';
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
