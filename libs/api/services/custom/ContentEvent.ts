...
/**
 * Api services for the `ContentEvent` model.
 *
 * **Details**
 *
 * Content: Manage Events in a Domain
 */
@Injectable()
export class ContentEventApi extends BaseLoopBackApi {
  constructor(
  ...
  public getStorageFile(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentEvents/:id/storageFile';
  ...
  public getSystemDomain(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentEvents/:id/systemDomain';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public getSystemUser(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentEvents/:id/systemUser';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public patchOrCreate(data: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentEvents';
    let _routeParams: any = {};
    let _postBody: any = {
      data: data
    };
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'PATCH';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentEvents/:id';
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {
  ...
  public _template_basic_remote(options: any = {}, params: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET';
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentEvents/_template_basic';
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
